...
public class Api_Jira_Main {
	 ...
	 *  datauser[2] = log_indra="";
	 *  datauser[3] = pass_indra="";
	 *  
	 *  projectuser[0] = project_vivo="";
	 *  projectuser[1] = issue_vivo ="";
	 *  projectuser[2] = project_indra=""; 
	 *  projectuser[3] = issuetype="ToDo";
	 *  
	 *  
	 */
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			Create_Get_Everything_Load cgel = new Create_Get_Everything_Load(datauser[0], datauser[1], projectuser[0], projectuser[1]);

			if (Create_Get_Everything_Load.duplicated==true)
			{
			...
			if (path_task.contains("ERRORMSG")) {
				...
				if (error > 20) {
					...
					if(Set_Projects_Vivo_Indra.end==true)
					{
			...
			String created_issue = ci.Create_Issue(datauser[2], datauser[3], uploadpath_json);
			...
			ConfigJira_Project.putlastissue(projectuser[0]);
