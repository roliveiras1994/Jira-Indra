...
public class ConfigJira_Login {
	...
	// method that reads the json file containing the login information for the
	// application to work
	...
	public static ArrayList<String> Logins() {
		...
		jsonObject = Create_Load_Delete_Read.ReadJson("logins.json");
		...
		for (int x = 0; x < logins.size(); x = x + 2) {
			// testing the logins.
			content_vivo = GetEverything.Get_Everything((String) logins.get(x), (String) logins.get(x + 1), "TRA3513",
					"1");
